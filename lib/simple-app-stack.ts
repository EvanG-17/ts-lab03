...
export class SimpleAppStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // Initialize the DynamoDB tables with data
    ...
    // Lambda for getting movie by ID
    ...
    // Grant read permissions to the getMovieById Lambda
    moviesTable.grantReadData(getMovieByIdFn);

    new cdk.CfnOutput(this, "Get Movie Function Url", { value: getMovieByIdURL.url });

    // Lambda for getting cast members
    ...
    // Grant read permissions to the getMovieCastMembers Lambda
    movieCastsTable.grantReadData(getMovieCastMembersFn);

    new cdk.CfnOutput(this, "Get Movie Cast Url", { value: getMovieCastMembersURL.url });

    // Define Simple Lambda Function
